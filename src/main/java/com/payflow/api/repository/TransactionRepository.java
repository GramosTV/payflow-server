...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    @Query(value = "SELECT t FROM Transaction t " +
            ...
            "ORDER BY t.createdAt DESC", countQuery = "SELECT count(t) FROM Transaction t WHERE t.sender = :user OR t.receiver = :user")
    ...
    @Query(value = "SELECT t FROM Transaction t " +
            ...
            "ORDER BY t.createdAt DESC", countQuery = "SELECT count(t) FROM Transaction t WHERE t.sourceWallet = :wallet OR t.destinationWallet = :wallet")
