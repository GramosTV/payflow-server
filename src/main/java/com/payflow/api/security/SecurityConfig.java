...
/**
 * Security configuration for the PayFlow API.
 * Configures JWT-based authentication, CORS, CSRF, security headers, and access
 * controls.
 */
@Configuration
@EnableWebSecurity
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class); // Disable
                                                                                                   // frameOptions for
                                                                                                   // H2 console
                                                                                                   // (development only
                                                                                                   // - remove in
