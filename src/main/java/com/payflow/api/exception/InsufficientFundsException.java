...
/**
 * Exception thrown when a transaction cannot be completed due to insufficient
 * funds
 */
public class InsufficientFundsException extends BadRequestException {
    ...
    public InsufficientFundsException(BigDecimal availableBalance, BigDecimal requestedAmount) {
        super("Insufficient funds: available balance " + availableBalance +
                " is less than requested amount " + requestedAmount);
