...
public class TransactionController {
        ...
        public ResponseEntity<List<TransactionResponse>> searchTransactions(
                ...
                List<Transaction> transactions = transactionService.getUserTransactionsInDateRange(user, startOfDay,
                                endOfDay);

                List<TransactionResponse> transactionResponses = transactions.stream()
                                .map(TransactionResponse::fromEntity).collect(Collectors.toList());
