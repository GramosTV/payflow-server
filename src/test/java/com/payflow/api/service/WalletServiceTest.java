...
public class WalletServiceTest {
    ...
    public void testCreateWallet_Success() {
        ...
        verify(walletRepository).save(any(Wallet.class));
        verify(transactionService).createDepositTransaction(any(Wallet.class), eq(walletRequest.getInitialDeposit()));
    }
    ...
    public void testCreateWallet_AlreadyExists() {
        ...
        // Act & Assert
        assertThrows(BadRequestException.class, () -> walletService.createWallet(testUser, walletRequest));
    ...
    public void testTopUpWallet_NotOwnWallet() {
        ...
        // up
        assertThrows(BadRequestException.class, () -> walletService.topUpWallet(differentUser, topUpRequest));
