...
public class ExchangeRateServiceTest {
    ...
    @BeforeEach
    public void setup() {
        ReflectionTestUtils.setField(exchangeRateService, "exchangeRateApiUrl", "https://api.example.com/latest/");
    ...
    public void testGetExchangeRate_DifferentCurrency() {
        ...
        // Verify
        verify(exchangeRateRepository).findByBaseCurrencyAndTargetCurrency(Wallet.Currency.USD, Wallet.Currency.EUR);
    }
    ...
    public void testGetExchangeRate_NotFound() {
        ...
        // Verify
        verify(exchangeRateRepository).findByBaseCurrencyAndTargetCurrency(Wallet.Currency.USD, Wallet.Currency.JPY);
    }
    ...
    public void testConvertCurrency() {
        ...
        BigDecimal convertedAmount = exchangeRateService.convertCurrency(
                amount, Wallet.Currency.USD, Wallet.Currency.EUR);
    ...
    public void testUpdateAllExchangeRates() throws Exception {
        ...
        Object rateResponse = Class.forName("com.payflow.api.service.ExchangeRateService$ExchangeRateApiResponse")
